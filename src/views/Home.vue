    ...
    <div>
        ...
        <header class="masthead">
            <div class="container">
                ...
                <router-link aria-label="Ir a la página principal" class="btn btn-light btn-lg text-uppercase" :to="{ name: 'Principal'}">Entra</router-link>
                <!--<a aria-label="Ir a la página principal" class="btn btn-light btn-lg text-uppercase">Entra</a>-->
            </div>
        </header>
