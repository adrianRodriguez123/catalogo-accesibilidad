        ...
        return {
            ...
            textos: [
                //WEB PERCEPTIBLE
                {
                    ...
                    tech: "web",
                    textoMostrado: "<p>Ofrecer textos alternativos para contenido no textual. Esto se puede conseguir con textos de gran tamaño, braille, audio, símbolos o lenguaje más simple. Para" +
                ...
                },
                {
                    ...
                    textoMostrado: "<p>Que sea distinguible consiste en realizar de una forma más sencilla que los usuarios puedan escuchar y ver el contenido." +
                        ...
                        "<br><img src='./imagenes/roleatributotooltip.PNG'/></li>" +
                        "</ul>" +
                        "</p>"
                },
                //WEB OPERABLE
                ...
                },
                {
                    ...
                    textoMostrado: "<p>Ofrecer a los usuarios el tiempo suficiente para leer y utilizar el contenido." +
                        ...
                        "<p>Para las aplicaciones web que requieran un inicio de sesión, cuando la sesión expire, se tendrá que haber guardado los datos, para que al autenticarse de nuevo sigan estando. Se debería además, avisar de cuanto tiempo lleva el usuario inactivo porque podrían causar pérdidas de datos.</p>" +
                        "</p>"
                },
                {
                    id: 6,
                ...
                },
                {
                    ...
                    textoMostrado: "<p>Ofrecer a los usuarios diferentes formas para navegar por el sitio web, encontrar contenido y determinar donde están." +
                        ...
                        "<img src='./imagenes/tituloweb.PNG' alt='Poner título a una web' /><br><br>" +
                        ...
                        "<img src='./imagenes/linkProposito1.PNG' alt='Primera forma indicar el propósito'/>" +
                        "</li><br>" +
                        "<li>" +
                        "<p>También lo podemos hacer mediante el atributo 'alt'</p>" +
                        "<img src='./imagenes/linkProposito2.PNG' alt='Segunda forma indicar el propósito'/>" +
                        "</li><br>" +
                        "<li>" +
                        "<p>También lo podemos hacer mediante el atributo 'aria-labelledby'</p>" +
                        "<img src='./imagenes/linkProposito3.PNG' alt='Tercera forma indicar el propósito'/>" +
                        "</li><br>" +
                        "<li>" +
                        "<p>También lo podemos hacer mediante el atributo 'aria-label'</p>" +
                        "<img src='./imagenes/linkProposito4.PNG' alt='Cuarta forma indicar el propósito'/>" +
                        "</li><br>" +
                        "</ul>" +
                        "<p>Es necesario proporcionar cabeceras, etiquetas y títulos descriptivos.</p>" +
                        "<p>Es importante añadir en la web el recurso llamado 'migas de pan' para que el usuario sepa en todo momento donde está y como ha llegado hasta ahí.</p>" +
                ...
                //WEB ENTENDIBLE
                {
                    ...
                    textoMostrado: "<p>Que el contenido sea legible y entendible." +
                        "<p>Se debe determinar el idioma por defecto de la página programáticamente, excepto en los nombres propios, terminos técnicos, palabras de otro idioma.</p>" +
                        "<img src='./imagenes/atributoLanguage.PNG' alt='Determinar el idioma de la página'/><br><br>" +
                ...
                },
                {
                    ...
                    tech: "web",
                    textoMostrado: "<p>Ayudar a los usuarios a evitar errores." +
                        ...
                        "<p>Si un error de entrada es detectado, se tiene que avisar al usuario y describir el error. Por ejemplo, al no cumplir uno de los requisitos registrando una contraseña, o al no rellenar un campo necesario de un formulario.</p><br>" +
                        ...
                        "<img src='./imagenes/ariainvalid.PNG' alt='Mostrar un error con el lector de pantalla' />" +
                        "<br><br><p>También podemos avisar al usuario mediante el atributo role con valor 'alertdialog'. El lector de pantalla será capaz de leer estos atributos.</p>" +
                        "<img src='./imagenes/roleAlertDialog.PNG' alt='Avisar al usuario mediante una alerta'/>" +
                        "<br><br><p>También es posible indicarle al lector de pantalla que un campo de texto es necesario rellenarlo.<br></p>" +
                        "<img src='./imagenes/ariarequired.PNG' alt='Marcar un campo como obligatorio'/>" +
                        "<br><br><p>Para las páginas web que poseen operaciones bancarias o compromisos legales es necesario que las operaciones sean reversibles, que los datos introducidos por el usuario sean comprobados y ofrecerles la oportunidad de corregirlos y que todo eso ocurra antes de realizar el envío de los datos.</p>" +
                        "</p>"
                },
                //WEB ROBUSTO
                {
                    ...
                    textoMostrado: "<p>Que el contenido actual y futuro pueda ser compatible en el mayor número de casos posible." +
                        ...
                        "<p>Es importante no olvidarse de indicar los nombres de los componentes de la interfaz de usuario, sus roles, sus valores, sus propiedades y sus estados, puesto que se puede hacer programáticamente y ayudan a las tecnologías de apoyo a que puedan interpretar mejor la página. Todo esto lo podemos indicar con los llamados atributos Aria-*. Estos son unos ejemplos  de algunos de ellos:</p>" +
                ...
                //ANDROID PERCEPTIBLE
                {
                    ...
                    tech: "android",
                    textoMostrado: "<p>Los móviles poseen una pantalla bastante pequeña comparada con la de un ordenador. Esto es un inconveniente para aquellas personas con problemas de visión. Por tanto es necesario realizar las fuentes y los iconos más grandes." +
                ...
                },
                {
                    ...
                    textoMostrado: "<p>Este punto es bastante importante para los usuarios de baja visión. Los " +
                        ...
                        "<p>El contraste es la diferencia de luz entre dos colores. Cuanto más contraste, mejor para que aquellas personas con problemas de vista. </p>" +
                        ...
                        "<br><br>La etiqueta color con nombre 'colorPrimary' corresponde al color de la barra superior y el atributo color con nombre  'colorAccent' corresponde a los colores de los controles de la interfaz. De esta manera los estamos sobreescribiendo para que tengan el color que nosotros queremos." +
                ...
                //ANDROID OPERABLE
                {
                    ...
                    textoMostrado: "<p>A diferencia de un ordenador, un teléfono no posee un teclado. Este es un componente vital para dar soporte a las personas con problemas físicos. Pero, aunque no se disponga de uno, siempre hay algún recurso. Se debe mencionar que sí se puede usar un teclado, cuando la app se esté desarrollando en un emulador.</p>" +
                        ...
                        "<img src='./imagenes/navegandoPantalla.PNG' alt='Apoyo para que TalkBack navegue por la pantalla'/>" +
                        "<br><br><p>Para mejorar la navegación por la pantalla, también podemos hacer uso del objeto llamado TtsSpan (Text-to-speech span). Con este objeto podremos decirle al lector de pantalla que lea en voz alta el texto que nosotros le indiquemos.</p>" +
                        "<p></p>" +
                        ""
                },
                //ANDROID ENTENDIBLE
                ...
                },
                {
                    ...
                    textoMostrado: "<p>Es importante saber como podemos realizar acciones por el usuario, como se suele hacer en servicios de accesibilidad. Estos servicios son los que pueden realizar acciones por los usuarios. Con la clase AccessibilityNodeInfo nos podemos ayudar para realizar todo este tipo de cosas, como por ejemplo funciones drag and drop, hacer click, mantener el foco, copiar, pegar,etc. Este es un pequeño ejemplo:</p>" +
                        "<img src='./imagenes/accesibilitynodeinfo.PNG' alt='Realizar acciones por el usuario'/>"
                },
            ]
        };
    }
